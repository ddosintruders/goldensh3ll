...
There are plans to allow for an install script that will require a minimal Arch configuration, or a fresh hyprland-supported distro.

> [!CAUTION]
> Please ensure to back-up any existing dotfiles configuration before installing GoldenSh3ll. I am not responsible for any lost configuration files since this project assumes you have a clean minimal installation.
